...
ms.locfileid: "116799376"
---
# <a name="appendix---port-specific-examples"></a>Приложение. Примеры для конкретных портов

## <a name="arm11-processor"></a>Процессор ARM11

### <a name="arm11-using-gcc"></a>ARM11 с поддержкой GCC

#### <a name="module-preamble-for-arm11-using-gcc"></a>Начальная часть модуля для ARM11 с поддержкой GCC
...
#### <a name="module-properties-for-arm11-using-gcc"></a>Свойства модуля для ARM11 с поддержкой GCC

| bit | Значение | Значение |
|---|---|---|
| [23–0] | 0 | Зарезервировано
| [31–24] | <br />0x00<br />0x01<br />0x02 | **Идентификатор компилятора**<br />IAR<br />ARM<br />GNU |

#### <a name="module-linker-for-arm11-using-gcc"></a>Компоновщик модулей для ARM11 с поддержкой GCC
...
#### <a name="building-modules-for-arm11-using-gcc"></a>Создание модулей для ARM11 с поддержкой GCC

Простой пример создания модуля ARM11 с поддержкой GCC с помощью командной строки:
...
#### <a name="thread-extension-definition-for-arm11-using-gcc"></a>Определение расширения потоков для ARM11 с поддержкой GCC
...
#### <a name="building-module-manager-for-arm11-using-gcc"></a>Создание диспетчера модулей для ARM11 с поддержкой GCC

Пример отсутствует.

#### <a name="attributes-for-external-memory-enable-api-for-arm11-using-gcc"></a>Атрибуты API включения внешней памяти для ARM11 с поддержкой GCC

Эта функция не включена для данного порта.

### <a name="arm11-using-ac5"></a>ARM11 с поддержкой AC5

#### <a name="module-preamble-for-arm11-using-ac5"></a>Начальная часть модуля для ARM11 с поддержкой AC5
...
#### <a name="module-properties-for-arm11-using-ac5"></a>Свойства модуля для ARM11 с поддержкой AC5
...
#### <a name="module-linker-for-arm11-using-ac5"></a>Компоновщик модулей для ARM11 с поддержкой AC5

Пример на основе командной строки без файла компоновщика.

#### <a name="building-modules-for-arm11-using-ac5"></a>Создание модулей для ARM11 с поддержкой AC5

Простой пример создания модуля ARM11 с поддержкой AC5 с помощью командной строки:
...
#### <a name="thread-extension-definition-for-arm11-using-ac5"></a>Определение расширения потоков для ARM11 с поддержкой AC5
...
#### <a name="building-module-manager-for-arm11-using-ac5"></a>Создание диспетчера модулей для ARM11 с поддержкой AC5

Простой пример создания диспетчера модулей ARM11 с поддержкой AC5 с помощью командной строки:
...
#### <a name="attributes-for-external-memory-enable-api-for-arm11-using-ac5"></a>Атрибуты API включения внешней памяти для ARM11 с поддержкой AC5

Эта функция не включена для данного порта.

## <a name="cortex-a7-processor"></a>Процессор Cortex-A7

### <a name="cortex-a7-using-ac5"></a>Cortex-A7 с поддержкой AC5

#### <a name="module-preamble-for-cortex-a7-using-ac5"></a>Начальная часть модуля для Cortex-A7 с поддержкой AC5
...
#### <a name="module-properties-for-cortex-a7-using-ac5"></a>Свойства модуля для Cortex-A7 с поддержкой AC5

| bit | Значение | Значение |
|---|---|---|
| 0 | 0<br />1 | Выполнение в привилегированном режиме<br />Выполнение в пользовательском режиме. |
| [23–1] | 0 | Зарезервировано
| [31–24] | <br />0x00<br />0x01<br />0x02 | **Идентификатор компилятора**<br />IAR<br />ARM<br />GNU |

#### <a name="module-linker-for-cortex-a7-using-ac5"></a>Компоновщик модулей для Cortex-A7 с поддержкой AC5

Пример на основе командной строки без файла компоновщика.

#### <a name="building-modules-for-cortex-a7-using-ac5"></a>Создание модулей для Cortex-A7 с поддержкой AC5

Простой пример создания модуля Cortex-A7 с поддержкой AC5 с помощью командной строки:
...
#### <a name="thread-extension-definition-for-cortex-a7-using-ac5"></a>Определение расширения потоков для Cortex-A7 с поддержкой AC5
...
#### <a name="building-module-manager-for-cortex-a7-using-ac5"></a>Создание диспетчера модулей для Cortex-A7 с поддержкой AC5

Простой пример создания диспетчера модулей Cortex-A7 с поддержкой AC5 с помощью командной строки:
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-a7-using-ac5"></a>Атрибуты API включения внешней памяти для Cortex-A7 с поддержкой AC5

Для настройки параметров общей памяти можно использовать следующие атрибуты:

| Параметр атрибута | Значение |
|---|---|
| TXM_MMU_ATTRIBUTE_XN | Никогда не выполнять. |
| TXM_MMU_ATTRIBUTE_B | Параметр B. |
| TXM_MMU_ATTRIBUTE_C | Параметр C. |
| TXM_MMU_ATTRIBUTE_AP | Параметр AP. |
| TXM_MMU_ATTRIBUTE_TEX | Параметр TEX. |

Сведения о настройке этих параметров см. в документации по ARM.

## <a name="cortex-m3-processor"></a>Процессор Cortex-M3

### <a name="cortex-m3-using-ac5"></a>Cortex-M3 с поддержкой AC5

#### <a name="module-preamble-for-cortex-m3-using-ac5"></a>Начальная часть модуля для Cortex-M3 с поддержкой AC5
...
#### <a name="module-properties-for-cortex-m3-using-ac5"></a>Свойства модуля для Cortex-M3 с поддержкой AC5
...
#### <a name="module-linker-for-cortex-m3-using-ac5"></a>Компоновщик модулей для Cortex-M3 с поддержкой AC5

Пример файла компоновщика не предоставляется. Компоновка выполняется в командной строке. Ознакомьтесь со следующим разделом.

#### <a name="building-modules-for-cortex-m3-using-ac5"></a>Создание модулей для Cortex-M3 с поддержкой AC5

Пример сценария создания приведен ниже.
...
#### <a name="thread-extension-definition-for-cortex-m3-using-ac5"></a>Определение расширения потоков для Cortex-M3 с поддержкой AC5
...
#### <a name="building-module-manager-for-cortex-m3-using-ac5"></a>Создание диспетчера модулей для Cortex-M3 с поддержкой AC5

Ознакомьтесь с примером build_threadx_module_manager_demo.bat.
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-m3-using-ac5"></a>Атрибуты API включения внешней памяти для Cortex-M3 с поддержкой AC5

Модуль всегда имеет доступ на чтение к общей памяти.

| Параметр атрибута | Значение |
|---|---|
| TXM_MODULE_MANAGER_SHARED_ATTRIBUTE_WRITE | Доступ для записи. |

### <a name="cortex-m3-using-ac6"></a>Cortex-M3 с поддержкой AC6

#### <a name="module-preamble-for-cortex-m3-using-ac6"></a>Начальная часть модуля для Cortex-M3 с поддержкой AC6
...
#### <a name="module-properties-for-cortex-m3-using-ac6"></a>Свойства модуля для Cortex-M3 с поддержкой AC6
...
#### <a name="module-linker-for-cortex-m3-using-ac6"></a>Компоновщик модулей для Cortex-M3 с поддержкой AC6

Файл компоновщика не используется. Ознакомьтесь с параметрами проекта.

#### <a name="building-modules-for-cortex-m3-using-ac6"></a>Создание модулей для Cortex-M3 с поддержкой AC6

Предоставлен пример рабочей области. Можно создать библиотеку ThreadX, библиотеку модулей ThreadX, пример проекта модуля и пример проекта диспетчера модулей.

#### <a name="thread-extension-definition-for-cortex-m3-using-ac6"></a>Определение расширения потоков для Cortex-M3 с поддержкой AC6
...
#### <a name="building-module-manager-for-cortex-m3-using-ac6"></a>Создание диспетчера модулей для Cortex-M3 с поддержкой AC6

Предоставлен пример рабочей области. Можно создать библиотеку ThreadX, библиотеку модулей ThreadX, пример проекта модуля и пример проекта диспетчера модулей.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m3-using-ac6"></a>Атрибуты API включения внешней памяти для Cortex-M3 с поддержкой AC6
...
### <a name="cortex-m3-using-gnu"></a>Cortex-M3 с поддержкой GNU

#### <a name="module-preamble-for-cortex-m3-using-gnu"></a>Начальная часть модуля для Cortex-M3 с поддержкой GNU
...
#### <a name="module-properties-for-cortex-m3-using-gnu"></a>Свойства модуля для Cortex-M3 с поддержкой GNU
...
#### <a name="module-linker-for-cortex-m3-using-gnu"></a>Компоновщик модулей для Cortex-M3 с поддержкой GNU
...
#### <a name="building-modules-for-cortex-m3-using-gnu"></a>Создание модулей для Cortex-M3 с поддержкой GNU

Ознакомьтесь с файлом build_threadx_module_sample.bat.
...
#### <a name="thread-extension-definition-for-cortex-m3-using-gnu"></a>Определение расширения потоков для Cortex-M3 с поддержкой GNU
...
#### <a name="building-module-manager-for-cortex-m3-using-gnu"></a>Создание диспетчера модулей для Cortex-M3 с поддержкой GNU

Ознакомьтесь с файлом build_threadx_module_manager_sample.bat.
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-m3-using-gnu"></a>Атрибуты API включения внешней памяти для Cortex-M3 с поддержкой GNU
...
### <a name="cortex-m3-using-iar"></a>Cortex-M3 с поддержкой IAR

#### <a name="module-preamble-for-cortex-m3-using-iar"></a>Начальная часть модуля для Cortex-M3 с поддержкой IAR
...
#### <a name="module-properties-for-cortex-m3-using-iar"></a>Свойства модуля для Cortex-M3 с поддержкой IAR
...
#### <a name="module-linker-for-cortex-m3-using-iar"></a>Компоновщик модулей для Cortex-M3 с поддержкой IAR
...
#### <a name="building-modules-for-cortex-m3-using-iar"></a>Создание модулей для Cortex-M3 с поддержкой IAR

Предоставлен пример рабочей области. Можно создать библиотеку ThreadX, библиотеку модулей ThreadX, проект демонстрационного модуля и проект демонстрационного диспетчера модулей.

#### <a name="thread-extension-definition-for-cortex-m3-using-iar"></a>Определение расширения потоков для Cortex-M3 с поддержкой IAR
...
#### <a name="building-module-manager-for-cortex-m3-using-iar"></a>Создание диспетчера модулей для Cortex-M3 с поддержкой IAR

Предоставлен пример рабочей области. Можно создать библиотеку ThreadX, библиотеку модулей ThreadX, проект демонстрационного модуля и проект демонстрационного диспетчера модулей.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m3-using-iar"></a>Атрибуты API включения внешней памяти для Cortex-M3 с поддержкой IAR
...
## <a name="cortex-m33-processor"></a>Процессор Cortex-M33

### <a name="cortex-m33-using-ac6"></a>Cortex-M33 с поддержкой AC6

#### <a name="module-preamble-for-cortex-m33-using-ac6"></a>Начальная часть модуля для Cortex-M33 с поддержкой AC6
...
#### <a name="module-properties-for-cortex-m33-using-ac6"></a>Свойства модуля для Cortex-M33 с поддержкой AC6
...
#### <a name="module-linker-for-cortex-m33-using-ac6"></a>Компоновщик модулей для Cortex-M33 с поддержкой AC6

Файл компоновщика для цепочки инструментов Keil не требуется. Ознакомьтесь с параметрами сборки в примере проекта.
Ниже перечислены важные параметры компоновщика.

```c
--entry demo_module_start --first __txm_module_preamble
```

#### <a name="building-modules-for-cortex-m33-using-ac6"></a>Создание модулей для Cortex-M33 с поддержкой AC6
...
#### <a name="thread-extension-definition-for-cortex-m33-using-ac6"></a>Определение расширения потоков для Cortex-M33 с поддержкой AC6
...
#### <a name="building-module-manager-for-cortex-m33-using-ac6"></a>Создание диспетчера модулей для Cortex-M33 с поддержкой AC6

Предоставлен пример рабочей области. Можно создать библиотеку ThreadX, библиотеку модулей ThreadX, проектsample_threadx_module и проект demo_threadx_non-secure_zone.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m33-using-ac6"></a>Атрибуты API включения внешней памяти для Cortex-M33 с поддержкой AC6
...
### <a name="cortex-m33-using-gnu"></a>Cortex-M33 с поддержкой GNU

#### <a name="module-preamble-for-cortex-m33-using-gnu"></a>Начальная часть модуля для Cortex-M33 с поддержкой GNU

#### <a name="module-properties-for-cortex-m33-using-gnu"></a>Свойства модуля для Cortex-M33 с поддержкой GNU
...
#### <a name="module-linker-for-cortex-m33-using-gnu"></a>Компоновщик модулей для Cortex-M33 с поддержкой GNU

#### <a name="building-modules-for-cortex-m33-using-gnu"></a>Создание модулей для Cortex-M33 с поддержкой GNU

#### <a name="thread-extension-definition-for-cortex-m33-using-gnu"></a>Определение расширения потоков для Cortex-M33 с поддержкой GNU

#### <a name="building-module-manager-for-cortex-m33-using-gnu"></a>Создание диспетчера модулей для Cortex-M33 с поддержкой GNU

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m33-using-gnu"></a>Атрибуты API включения внешней памяти для Cortex-M33 с поддержкой GNU
...
### <a name="cortex-m33-using-iar"></a>Cortex-M33 с поддержкой IAR

#### <a name="module-preamble-for-cortex-m33-using-iar"></a>Начальная часть модуля для Cortex-M33 с поддержкой IAR
...
#### <a name="module-properties-for-cortex-m33-using-iar"></a>Свойства модуля для Cortex-M33 с поддержкой IAR
...
#### <a name="module-linker-for-cortex-m33-using-iar"></a>Компоновщик модулей для Cortex-M33 с поддержкой IAR
...
#### <a name="building-modules-for-cortex-m33-using-iar"></a>Создание модулей для Cortex-M33 с поддержкой IAR

#### <a name="thread-extension-definition-for-cortex-m33-using-iar"></a>Определение расширения потоков для Cortex-M33 с поддержкой IAR
...
#### <a name="building-module-manager-for-cortex-m33-using-iar"></a>Создание диспетчера модулей для Cortex-M33 с поддержкой IAR

Пример рабочей области еще не предоставлен. Ожидается в ближайшее время.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m33-using-iar"></a>Атрибуты API включения внешней памяти для Cortex-M33 с поддержкой IAR
...
## <a name="cortex-m4-processor"></a>Процессор Cortex-M4

### <a name="cortex-m4-using-ac5"></a>Cortex-M4 с поддержкой AC5

#### <a name="module-preamble-for-cortex-m4-using-ac5"></a>Начальная часть модуля для Cortex-M4 с поддержкой AC5
...
#### <a name="module-properties-for-cortex-m4-using-ac5"></a>Свойства модуля для Cortex-M4 с поддержкой AC5
...
#### <a name="module-linker-for-cortex-m4-using-ac5"></a>Компоновщик модулей для Cortex-M4 с поддержкой AC5

Пример файла компоновщика не предоставляется. Компоновка выполняется в командной строке. Ознакомьтесь со следующим разделом.

#### <a name="building-modules-for-cortex-m4-using-ac5"></a>Создание модулей для Cortex-M4 с поддержкой AC5

Ознакомьтесь с примером файла build_threadx_module_demo.bat.
...
#### <a name="thread-extension-definition-for-cortex-m4-using-ac5"></a>Определение расширения потоков для Cortex-M4 с поддержкой AC5
...
#### <a name="building-module-manager-for-cortex-m4-using-ac5"></a>Создание диспетчера модулей для Cortex-M4 с поддержкой AC5

Ознакомьтесь с примером файла build_threadx_module_manager_demo.bat.
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-m4-using-ac5"></a>Атрибуты API включения внешней памяти для Cortex-M4 с поддержкой AC5
...
### <a name="cortex-m4-using-ac6"></a>Cortex-M4 с поддержкой AC6

#### <a name="module-preamble-for-cortex-m4-using-ac6"></a>Начальная часть модуля для Cortex-M4 с поддержкой AC6
...
#### <a name="module-properties-for-cortex-m4-using-ac6"></a>Свойства модуля для Cortex-M4 с поддержкой AC6
...
#### <a name="module-linker-for-cortex-m4-using-ac6"></a>Компоновщик модулей для Cortex-M4 с поддержкой AC6

Файл компоновщика не используется. Ознакомьтесь с параметрами проекта.

#### <a name="building-modules-for-cortex-m4-using-ac6"></a>Создание модулей для Cortex-M4 с поддержкой AC6

Предоставлен пример рабочей области. Можно создать библиотеку ThreadX, библиотеку модулей ThreadX, пример проекта модуля и пример проекта диспетчера модулей.

#### <a name="thread-extension-definition-for-cortex-m4-using-ac6"></a>Определение расширения потоков для Cortex-M4 с поддержкой AC6
...
#### <a name="building-module-manager-for-cortex-m4-using-ac6"></a>Создание диспетчера модулей для Cortex-M4 с поддержкой AC6

Предоставлен пример рабочей области. Можно создать библиотеку ThreadX, библиотеку модулей ThreadX, пример проекта модуля и пример проекта диспетчера модулей.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m4-using-ac6"></a>Атрибуты API включения внешней памяти для Cortex-M4 с поддержкой AC6
...
### <a name="cortex-m4-using-gnu"></a>Cortex-M4 с поддержкой GNU

#### <a name="module-preamble-for-cortex-m4-using-gnu"></a>Начальная часть модуля для Cortex-M4 с поддержкой GNU
...
#### <a name="module-properties-for-cortex-m4-using-gnu"></a>Свойства модуля для Cortex-M4 с поддержкой GNU
...
#### <a name="module-linker-for-cortex-m4-using-gnu"></a>Компоновщик модулей для Cortex-M4 с поддержкой GNU
...
#### <a name="building-modules-for-cortex-m4-using-gnu"></a>Создание модулей для Cortex-M4 с поддержкой GNU
...
#### <a name="thread-extension-definition-for-cortex-m4-using-gnu"></a>Определение расширения потоков для Cortex-M4 с поддержкой GNU
...
#### <a name="building-module-manager-for-cortex-m4-using-gnu"></a>Создание диспетчера модулей для Cortex-M4 с поддержкой GNU
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-m4-using-gnu"></a>Атрибуты API включения внешней памяти для Cortex-M4 с поддержкой GNU
...
### <a name="cortex-m4-using-iar"></a>Cortex-M4 с поддержкой IAR

#### <a name="module-preamble-for-cortex-m4-using-iar"></a>Начальная часть модуля для Cortex-M4 с поддержкой IAR
...
#### <a name="module-properties-for-cortex-m4-using-iar"></a>Свойства модуля для Cortex-M4 с поддержкой IAR
...
#### <a name="module-linker-for-cortex-m4-using-iar"></a>Компоновщик модулей для Cortex-M4 с поддержкой IAR
...
#### <a name="building-modules-for-cortex-m4-using-iar"></a>Создание модулей для Cortex-M4 с поддержкой IAR

Предоставлен пример рабочей области. Можно создать библиотеку ThreadX, библиотеку модулей ThreadX, проект демонстрационного модуля и проект демонстрационного диспетчера модулей.

#### <a name="thread-extension-definition-for-cortex-m4-using-iar"></a>Определение расширения потоков для Cortex-M4 с поддержкой IAR
...
#### <a name="building-module-manager-for-cortex-m4-using-iar"></a>Создание диспетчера модулей для Cortex-M4 с поддержкой IAR

Предоставлен пример рабочей области. Можно создать библиотеку ThreadX, библиотеку модулей ThreadX, проект демонстрационного модуля и проект демонстрационного диспетчера модулей.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m4-using-iar"></a>Атрибуты API включения внешней памяти для Cortex-M4 с поддержкой IAR
...
## <a name="cortex-m7-processor"></a>Процессор Cortex-M7

### <a name="cortex-m7-using-ac5"></a>Cortex-M7 с поддержкой AC5

#### <a name="module-preamble-for-cortex-m7-using-ac5"></a>Начальная часть модуля для Cortex-M7 с поддержкой AC5
...
#### <a name="module-properties-for-cortex-m7-using-ac5"></a>Свойства модуля для Cortex-M7 с поддержкой AC5
...
#### <a name="module-linker-for-cortex-m7-using-ac5"></a>Компоновщик модулей для Cortex-M7 с поддержкой AC5

Пример на основе командной строки без файла компоновщика.

#### <a name="building-modules-for-cortex-m7-using-ac5"></a>Создание модулей для Cortex-M7 с поддержкой AC5

Простой пример создания модуля Cortex-M7 с поддержкой AC5 с помощью командной строки:
...
#### <a name="thread-extension-definition-for-cortex-m7-using-ac5"></a>Определение расширения потоков для Cortex-M7 с поддержкой AC5
...
#### <a name="building-module-manager-for-cortex-m7-using-ac5"></a>Создание диспетчера модулей для Cortex-M7 с поддержкой AC5

Простой пример создания диспетчера модулей Cortex-M7 с поддержкой AC5 с помощью командной строки:
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-m7-using-ac5"></a>Атрибуты API включения внешней памяти для Cortex-M7 с поддержкой AC5

### <a name="cortex-m7-using-ac6"></a>Cortex-M7 с поддержкой AC6

#### <a name="module-properties-for-cortex-m7-using-ac6"></a>Свойства модуля для Cortex-M7 с поддержкой AC6
...
#### <a name="module-linker-for-cortex-m7-using-ac6"></a>Компоновщик модулей для Cortex-M7 с поддержкой AC6

Файл компоновщика не используется. Ознакомьтесь с параметрами проекта.

#### <a name="building-modules-for-cortex-m7-using-ac6"></a>Создание модулей для Cortex-M7 с поддержкой AC6

Предоставлен пример рабочей области. Можно создать библиотеку ThreadX, библиотеку модулей ThreadX, пример проекта модуля и пример проекта диспетчера модулей.

#### <a name="thread-extension-definition-for-cortex-m7-using-ac6"></a>Определение расширения потоков для Cortex-M7 с поддержкой AC6
...
#### <a name="building-module-manager-for-cortex-m7-using-ac6"></a>Создание диспетчера модулей для Cortex-M7 с поддержкой AC6

Предоставлен пример рабочей области. Можно создать библиотеку ThreadX, библиотеку модулей ThreadX, пример проекта модуля и пример проекта диспетчера модулей.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m7-using-ac6"></a>Атрибуты API включения внешней памяти для Cortex-M7 с поддержкой AC6
...
### <a name="cortex-m7-using-gnu"></a>Cortex-M7 с поддержкой GNU

#### <a name="module-properties-for-cortex-m7-using-gnu"></a>Свойства модуля для Cortex-M7 с поддержкой GNU
...
#### <a name="module-linker-for-cortex-m7-using-gnu"></a>Компоновщик модулей для Cortex-M7 с поддержкой GNU
...
#### <a name="building-modules-for-cortex-m7-using-gnu"></a>Создание модулей для Cortex-M7 с поддержкой GNU
...
#### <a name="thread-extension-definition-for-cortex-m7-using-gnu"></a>Определение расширения потоков для Cortex-M7 с поддержкой GNU
...
#### <a name="building-module-manager-for-cortex-m7-using-gnu"></a>Создание диспетчера модулей для Cortex-M7 с поддержкой GNU
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-m7-using-gnu"></a>Атрибуты API включения внешней памяти для Cortex-M7 с поддержкой GNU
...
### <a name="cortex-m7-using-iar"></a>Cortex-M7 с поддержкой IAR

#### <a name="module-preamble-for-cortex-m7-using-iar"></a>Начальная часть модуля для Cortex-M7 с поддержкой IAR
...
#### <a name="module-properties-for-cortex-m7-using-iar"></a>Свойства модуля для Cortex-M7 с поддержкой IAR
...
#### <a name="module-linker-for-cortex-m7-using-iar"></a>Компоновщик модулей для Cortex-M7 с поддержкой IAR
...
#### <a name="building-modules-for-cortex-m7-using-iar"></a>Создание модулей для Cortex-M7 с поддержкой IAR

Предоставлен пример рабочей области. Можно создать библиотеку ThreadX, библиотеку модулей ThreadX, проект демонстрационного модуля и проект демонстрационного диспетчера модулей.

#### <a name="thread-extension-definition-for-cortex-m7-using-iar"></a>Определение расширения потоков для Cortex-M7 с поддержкой IAR
...
#### <a name="building-module-manager-for-cortex-m7-using-iar"></a>Создание диспетчера модулей для Cortex-M7 с поддержкой IAR

Предоставлен пример рабочей области. Можно создать библиотеку ThreadX, библиотеку модулей ThreadX, проект демонстрационного модуля и проект демонстрационного диспетчера модулей.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-m7-using-iar"></a>Атрибуты API включения внешней памяти для Cortex-M7 с поддержкой IAR
...
## <a name="cortex-r4-processor"></a>Процессор Cortex-R4

### <a name="cortex-r4-using-ac6"></a>Cortex-R4 с поддержкой AC6

#### <a name="module-preamble-for-cortex-r4-using-ac6"></a>Начальная часть модуля для Cortex-R4 с поддержкой AC6
...
#### <a name="module-properties-for-cortex-r4-using-ac6"></a>Свойства модуля для Cortex-R4 с поддержкой AC6
...
#### <a name="module-linker-for-cortex-r4-using-ac6"></a>Компоновщик модулей для Cortex-R4 с поддержкой AC6

Пример на основе командной строки без файла компоновщика.

#### <a name="building-modules-for-cortex-r4-using-ac6"></a>Создание модулей для Cortex-R4 с поддержкой AC6

Простой пример создания модуля Cortex-R4 с поддержкой AC6 с помощью командной строки:
...
#### <a name="thread-extension-definition-for-cortex-r4-using-ac6"></a>Определение расширения потоков для Cortex-R4 с поддержкой AC6
...
#### <a name="building-module-manager-for-cortex-r4-using-ac6"></a>Создание диспетчера модулей для Cortex-R4 с поддержкой AC6
...
#### <a name="attributes-for-external-memory-enable-api-for-cortex-r4-using-ac6"></a>Атрибуты API включения внешней памяти для Cortex-R4 с поддержкой AC6
...
### <a name="cortex-r4-using-iar"></a>Cortex-R4 с поддержкой IAR

#### <a name="module-preamble-for-cortex-r4-using-iar"></a>Начальная часть модуля для Cortex-R4 с поддержкой IAR
...
#### <a name="module-properties-for-cortex-r4-using-iar"></a>Свойства модуля для Cortex-R4 с поддержкой IAR
...
#### <a name="module-linker-for-cortex-r4-using-iar"></a>Компоновщик модулей для Cortex-R4 с поддержкой IAR
...
#### <a name="building-modules-for-cortex-r4-using-iar"></a>Создание модулей для Cortex-R4 с поддержкой IAR

Предоставлен пример рабочей области. Можно создать библиотеку ThreadX, библиотеку модулей ThreadX, проект демонстрационного модуля и проект демонстрационного диспетчера модулей.

#### <a name="thread-extension-definition-for-cortex-r4-using-iar"></a>Определение расширения потоков для Cortex-R4 с поддержкой IAR
...
#### <a name="building-module-manager-for-cortex-r4-using-iar"></a>Создание диспетчера модулей для Cortex-R4 с поддержкой IAR

Предоставлен пример рабочей области. Можно создать библиотеку ThreadX, библиотеку модулей ThreadX, проект демонстрационного модуля и проект демонстрационного диспетчера модулей.

#### <a name="attributes-for-external-memory-enable-api-for-cortex-r4-using-iar"></a>Атрибуты API включения внешней памяти для Cortex-R4 с поддержкой IAR
...
## <a name="mcf544xx-processor"></a>Процессор MCF544xx

### <a name="mcf544xx-using-ghs"></a>MCF544xx с поддержкой GHS

#### <a name="module-preamble-for-mcf544xx-using-ghs"></a>Начальная часть модуля для MCF544xx с поддержкой GHS
...
#### <a name="module-properties-for-mcf544xx-using-ghs"></a>Свойства модуля для MCF544xx с поддержкой GHS

| bit | Значение | Значение |
|---|---|---|
| 0 | 0<br />1 | Выполнение в привилегированном режиме<br />Выполнение в пользовательском режиме |
| 1 | 0<br />1 | Без защиты MMU.<br />Защита MMU (необходимо выбрать пользовательский режим). |
| 2 | 0<br />1 | Отключение доступа к общей или внешней памяти<br />Включение доступа к общей или внешней памяти |
| [23–3] | 0 | Зарезервировано
| [31–24] | <br />0x03 | **Идентификатор компилятора**<br />GHS |

#### <a name="module-linker-for-mcf544xx-using-ghs"></a>Компоновщик модулей для MCF544xx с поддержкой GHS
...
#### <a name="building-modules-for-mcf544xx-using-ghs"></a>Создание модулей для MCF544xx с поддержкой GHS

Предоставлен пример рабочей области. Можно создать библиотеку ThreadX, библиотеку модулей ThreadX, проект демонстрационного модуля и проект демонстрационного диспетчера модулей.

#### <a name="thread-extension-definition-for-mcf544xx-using-ghs"></a>Определение расширения потоков для MCF544xx с поддержкой GHS
...
#### <a name="building-module-manager-for-mcf544xx-using-ghs"></a>Создание диспетчера модулей для MCF544xx с поддержкой GHS

Предоставлен пример рабочей области. Можно создать библиотеку ThreadX, библиотеку модулей ThreadX, проект демонстрационного модуля и проект демонстрационного диспетчера модулей.

#### <a name="attributes-for-external-memory-enable-api-for-mcf544xx-using-ghs"></a>Атрибуты API включения внешней памяти для MCF544xx с поддержкой GHS

Эта функция не включена в MCF544xx.

## <a name="rx63-processor"></a>Процессор RX63

### <a name="rx63-using-iar"></a>RX63 с поддержкой IAR

#### <a name="module-preamble-for-rx63-using-iar"></a>Начальная часть модуля для RX63 с поддержкой IAR
...
#### <a name="module-properties-for-rx63-using-iar"></a>Свойства модуля для RX63 с поддержкой IAR
...
| 2 | 0<br />1 | Отключение доступа к общей или внешней памяти<br />Включение доступа к общей или внешней памяти |
| [23–3] | 0 | Зарезервировано
| [31–24] | <br />0x00<br />0x02 | **Идентификатор компилятора**<br />IAR<br />GNU |

#### <a name="module-linker-for-rx63-using-iar"></a>Компоновщик модулей для RX63 с поддержкой IAR
...
#### <a name="building-modules-for-rx63-using-iar"></a>Создание модулей для RX63 с поддержкой IAR

Предоставлен пример рабочей области. Можно создать библиотеку ThreadX, библиотеку модулей ThreadX, проект демонстрационного модуля и проект демонстрационного диспетчера модулей.

#### <a name="thread-extension-definition-for-rxrx635n-using-iar"></a>Определение расширения потоков для RX635N с поддержкой IAR
...
#### <a name="building-module-manager-for-rx63-using-iar"></a>Создание диспетчера модулей для RX63 с поддержкой IAR

Предоставлен пример рабочей области. Можно создать библиотеку ThreadX, библиотеку модулей ThreadX, проект демонстрационного модуля и проект демонстрационного диспетчера модулей.

#### <a name="attributes-for-external-memory-enable-api-for-rx63-using-iar"></a>Атрибуты API включения внешней памяти для RX63 с поддержкой IAR

| Параметр атрибута | Значение |
|---|---|
| TXM_MODULE_MANAGER_SHARED_ATTRIBUTE_EXECUTE | Выполнение кода |
| TXM_MODULE_MANAGER_SHARED_ATTRIBUTE_WRITE | Доступ для записи. |
| TXM_MODULE_MANAGER_SHARED_ATTRIBUTE_READ | Доступ на чтение. |

## <a name="rx65n-processor"></a>Процессор RX65N

### <a name="rx65n-using-iar"></a>RX65N с поддержкой IAR

#### <a name="module-preamble-for-rx65n-using-iar"></a>Начальная часть модуля для RX65N с поддержкой IAR
...
#### <a name="module-properties-for-rx65n-using-iar"></a>Свойства модуля для RX65N с поддержкой IAR
...
#### <a name="module-linker-for-rx65n-using-iar"></a>Компоновщик модулей для RX65N с поддержкой IAR
...
#### <a name="building-modules-for-rx65n-using-iar"></a>Создание модулей для RX65N с поддержкой IAR

Предоставлен пример рабочей области. Можно создать библиотеку ThreadX, библиотеку модулей ThreadX, проект демонстрационного модуля и проект демонстрационного диспетчера модулей.

#### <a name="thread-extension-definition-for-rx65n-using-iar"></a>Определение расширения потоков для RX65N с поддержкой IAR
...
#### <a name="building-module-manager-for-rx65n-using-iar"></a>Создание диспетчера модулей для RX65N с поддержкой IAR

Предоставлен пример рабочей области. Можно создать библиотеку ThreadX, библиотеку модулей ThreadX, проект демонстрационного модуля и проект демонстрационного диспетчера модулей.

#### <a name="attributes-for-external-memory-enable-api-for-rx65n-using-iar"></a>Атрибуты API включения внешней памяти для RX65N с поддержкой IAR
