...
Большинство средств разработки разделяют представление программы приложения на пять основных областей: *инструкция*, *константа*, *инициализированные данные*, *неинициализированные данные* и *стек потоков GUIX*. На рисунке X на странице X показан пример этих областей памяти.
...
| 32-битная             | Для каждого пикселя требуется 4 байта и альфа-канал. Может использоваться порядок байтов a:r:g:b или b:g:r:a, определяется оборудованием.              |
