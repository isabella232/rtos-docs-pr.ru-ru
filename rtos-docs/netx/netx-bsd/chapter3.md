---
title: Глава 3. Службы BSD в NetX для ОСРВ Azure
description: В этой главе приводится описание всех базовых служб BSD в NetX для ОСРВ Azure (перечислены ниже в алфавитном порядке).
author: philmea
ms.author: philmea
ms.date: 06/04/2020
ms.topic: article
...
ms.locfileid: "104814452"
---
# <a name="chapter-3---azure-rtos-netx-bsd-services"></a><span data-ttu-id="d0aad-103">Глава 3. Службы BSD в NetX для ОСРВ Azure</span><span class="sxs-lookup"><span data-stu-id="d0aad-103">Chapter 3 - Azure RTOS NetX BSD Services</span></span>

<span data-ttu-id="d0aad-104">В этой главе приводится описание всех базовых служб BSD в NetX для ОСРВ Azure (перечислены ниже в алфавитном порядке).</span><span class="sxs-lookup"><span data-stu-id="d0aad-104">This chapter contains a description of all Azure RTOS NetX BSD basic services listed below in alphabetic order.</span></span>
