...
---
# <a name="chapter-3---azure-rtos-netx-bsd-services"></a>Глава 3. Службы BSD в NetX для ОСРВ Azure

В этой главе приводится описание всех базовых служб BSD в NetX для ОСРВ Azure (перечислены ниже в алфавитном порядке).
