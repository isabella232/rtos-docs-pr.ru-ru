...
Параметр конфигурации клиента ОСРВ Azure NetX DHDP, NX_DHCP_CLIENT_RESTORE_STATE, позволяет системе восстанавливать созданный ранее клиент DHCP в состоянии BOUND после перезагрузки системы.
...
> [!NOTE]
> Она не предназначена для использования со службами *nx_dhcp_client_get_record* и *nx_dhcp_client_restore_record*, описанными выше. Эти службы были рассмотрены ранее в этом разделе.
