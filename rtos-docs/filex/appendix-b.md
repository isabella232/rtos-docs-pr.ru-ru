...
ms.locfileid: "116783821"
---
# <a name="appendix-b---azure-rtos-filex-constants"></a>Приложение B. Константы FileX для ОСРВ Azure

## <a name="alphabeticlistings"></a>Алфавитный список 
