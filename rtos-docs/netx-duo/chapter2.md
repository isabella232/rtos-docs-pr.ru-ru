...
|NX_ENABLE_TCPIP_OFFLOAD | Символ, который отвечает за включение функции разгрузки TCP/IP. Обратите внимание, что для включения этой функции нужно определить NX_ENABLE_INTERFACE_CAPABILITY.|
