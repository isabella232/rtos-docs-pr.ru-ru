...
ms.locfileid: "116790145"
---
# <a name="appendix-a---azure-rtos-netx-duo-services"></a>Приложение A. Службы NetX Duo для ОСРВ Azure

## <a name="address-resolution-protocol-arp"></a>Протокол разрешения адресов (ARP)  
...
UINT     nx_igmp_multicast_leave(NX_IP *ip_ptr,
            ULONG group_address);
```
## <a name="internet-protocol-ip"></a>Протокол Интернета (IP) 
...
## <a name="packet-management"></a>Управление пакетами  
...
## <a name="reverse-address-resolution-protocol-rarp"></a>Обратный протокол разрешения адресов (RARP)  
...
## <a name="system-management"></a>Управление системами  
