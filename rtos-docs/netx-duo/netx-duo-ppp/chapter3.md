...
- **nx_ppp_secondary_dns_address_set**: *настройка IP-адреса вторичного сервера DNS*
...
- **NX_SUCCESS** (0x00): запрос PPP инициирован успешно.
...
- **NX_SUCCESS** (0x00): успешное получение адреса DNS.
...
Настройка IP-адреса основного DNS-сервера
...
- **NX_SUCCESS** (0x00): успешное сохранение адреса DNS.
- **NX_PPP_NOT_ESTABLISHED** (0xB5): не завершено согласование PPP с одноранговым узлом.
- NX_PTR_ERROR (0x07): недопустимый указатель PPP.
...
Настройка IP-адреса дополнительного DNS-сервера
...
- **NX_IN_PROGRESS** (0x37): не завершена инициализация PPP.
- NX_PTR_ERROR (0x07): недопустимый указатель PPP.
...
Уведомление приложения об отключении канала
...
Уведомление приложения о включении канала
...
При получении соответствующего ответа на проверку связи установленный флаг будет снят задачей потока PPP. Устройство PPP должно выполнить часть согласования PPP, относящуюся к LCP.
...
- **NX_PPP_ALREADY_STARTED** (0xb9): соединение PPP уже запущено.
- NX_PTR_ERROR (0x07): недопустимый указатель PPP.
- NX_CALLER_ERROR (0x11): недопустимый вызывающий объект для этой службы.
...
Определение функции отправки пакета PPP
