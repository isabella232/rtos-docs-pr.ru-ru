...
ms.locfileid: "116791199"
---
# <a name="chapter-3---description-of-azure-rtos-netx-duo-autoip-services"></a>Глава 3. Описание служб ОСРВ Azure NetX Duo AutoIP

В этой главе приведено описание всех служб ОСРВ Azure NetX Duo AutoIP, которые перечислены ниже в алфавитном порядке.
...
- **NX_AUTO_IP_BAD_INTERFACE_INDEX** (0xA02): недопустимый сетевой интерфейс. NX_PTR_ERROR (0x16): недопустимый указатель AutoIP.
- NX_CALLER_ERROR (0x11): недопустимый вызывающий объект для этой службы.
