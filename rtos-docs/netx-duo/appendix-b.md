...
ms.locfileid: "116789822"
---
# <a name="appendix-b---azure-rtos-netx-duo-constants"></a>Приложение B. Константы NetX Duo для ОСРВ Azure

## <a name="alphabetic-listing"></a>Алфавитный список
...
<tr class="even">
<td>NX_ICMP_PACKET (протокол IPv6 включен)</td>
<td>56</td>
</tr>
<tr class="odd">
<td>NX_ICMP_PACKET (протокол IPv6 отключен)</td>
<td>36</td>
</tr>
<tr class="even">
...
<tr class="odd">
<td>NX_IP_PACKET (протокол IPv6 включен)</td>
<td>56</td>
</tr>
<tr class="even">
<td>NX_IP_PACKET (протокол IPv6 отключен)</td>
<td>36</td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td>NX_TCP_PACKET (протокол IPv6 включен)</td>
<td>76</td>
</tr>
<tr class="even">
<td>NX_TCP_PACKET (протокол IPv6 отключен)</td>
<td>56</td>
</tr>
<tr class="odd">
...
<tr class="even">
<td>NX_UDP_PACKET (протокол IPv6 включен)</td>
<td>64</td>
</tr>
<tr class="odd">
<td>NX_UDP_PACKET (протокол IPv6 отключен)</td>
<td>44</td>
</tr>
<tr class="even">
...
## <a name="listings-by-value"></a>Список по значению  
