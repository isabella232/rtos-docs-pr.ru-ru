---
title: Глава 3. Службы ОСРВ Azure NetX BSD
description: В этой главе приведено описание всех базовых служб ОСРВ Azure NetX Duo BSD, которые перечислены ниже в алфавитном порядке.
author: philmea
ms.author: philmea
ms.date: 06/04/2020
ms.topic: article
...
ms.locfileid: "104814820"
---
# <a name="chapter-3---azure-rtos-netx-duo-bsd-services"></a><span data-ttu-id="1f6b1-103">Глава 3. Службы ОСРВ Azure NetX BSD</span><span class="sxs-lookup"><span data-stu-id="1f6b1-103">Chapter 3 - Azure RTOS NetX Duo BSD Services</span></span>

<span data-ttu-id="1f6b1-104">В этой главе приведено описание всех базовых служб ОСРВ Azure NetX Duo BSD, которые перечислены ниже в алфавитном порядке.</span><span class="sxs-lookup"><span data-stu-id="1f6b1-104">This chapter contains a description of all Azure RTOS NetX Duo BSD basic services (listed below) in alphabetic order.</span></span>
