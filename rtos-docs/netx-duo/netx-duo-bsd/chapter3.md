...
ms.locfileid: "116791182"
---
# <a name="chapter-3---azure-rtos-netx-duo-bsd-services"></a>Глава 3. Службы ОСРВ Azure NetX BSD

В этой главе приведено описание всех базовых служб ОСРВ Azure NetX Duo BSD, которые перечислены ниже в алфавитном порядке.
