...
ms.locfileid: "116798849"
---
# <a name="appendix-a---azure-rtos-threadx-smp-api-services"></a>Приложение А. Службы API в ОСРВ Azure ThreadX SMP

## <a name="entry-function"></a>Функция входа
...
```
## <a name="event-flags-services"></a>Службы флагов событий
...
```
## <a name="mutex-services"></a>Службы мьютексов
...
```
## <a name="queue-services"></a>Службы очередей
...
```
## <a name="semaphore-services"></a>Службы семафоров
...
UINT     tx_semaphore_put_notify(TX_SEMAPHORE
            ...
            *));
```
## <a name="thread-control-services"></a>Службы управления потоками
...
```
## <a name="time-services"></a>Службы времени

```C
ULONG     tx_time_get(VOID);
VOID      tx_time_set(ULONG new_time);
```
## <a name="timer-services"></a>Службы таймеров
