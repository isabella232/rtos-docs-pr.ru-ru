...
- [**Алфавитный список**](#alphabetic-listings) 
- [**Список по значению**](#listing-by-value)

## <a name="alphabetic-listings"></a>Алфавитный список

| Константа (по алфавиту) | Значение |
| --------- | - |
| TX_1_ULONG | 1 |
| TX_2_ULONG | 2 |
| TX_4_ULONG | 4 |
...
## <a name="listing-by-value"></a>Список по значению

| Константа (по значению) | Значение  |
| ------------- | - |
| TX_DONT_START | 0 |
| TX_FALSE | 0 |
| TX_NO_ACTIVATE | 0 |
