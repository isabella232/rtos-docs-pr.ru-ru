---
title: Приложение А. Пример tx_port.h
description: В этой главе представлен пример файла tx_port.h.
author: philmea
ms.service: rtos
ms.topic: article
ms.date: 5/19/2020
...
ms.locfileid: "104815952"
---
# <a name="appendix-a---sample-tx_porth"></a><span data-ttu-id="e0367-103">Приложение А. Пример tx_port.h</span><span class="sxs-lookup"><span data-stu-id="e0367-103">Appendix A - Sample tx_port.h</span></span>

<span data-ttu-id="e0367-104">В этой главе представлен пример файла **tx_port.h**.</span><span class="sxs-lookup"><span data-stu-id="e0367-104">This chapter displays a sample **tx_port.h** file.</span></span>
