---
title: Приложение Б. Файл tx_trace.h
description: В этой главе описывается файл tx_trace.h.
author: philmea
ms.service: rtos
ms.topic: article
ms.date: 5/19/2020
...
---
# <a name="appendix-b---the-tx_traceh-file"></a><span data-ttu-id="13193-103">Приложение Б. Файл tx_trace.h</span><span class="sxs-lookup"><span data-stu-id="13193-103">Appendix B - The tx_trace.h file</span></span>

<span data-ttu-id="13193-104">В этой главе описывается файл **tx_trace.h**.</span><span class="sxs-lookup"><span data-stu-id="13193-104">This chapter displays the **tx_trace.h** file.</span></span>
